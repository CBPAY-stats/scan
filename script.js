...
class XDBWalletExplorer {
    ...
    displayWalletInfo(accountInfo) {
        ...
        balances.forEach(balance => {
            let assetCode = balance.asset_type === 'native' ? 'XDB' : balance.asset_code;
            balancesHtml += `
                <div class="wallet-stat">
                    <div class="wallet-stat-label">${assetCode} Balance</div>
                    <div class="wallet-stat-value amount">${parseFloat(balance.balance).toFixed(7)} ${assetCode}</div>
                </div>
            `;
        });
            ...
            <div class="transaction-item">
                ...
                <div class="item-details">
                    <div class="detail-item">
                        ...
                        <div class="detail-value hash"><a href="https://live.xdbchain.com/tx/${tx.hash}" target="_blank">${tx.hash}</a></div>
                    </div>
                    <div class="detail-item">
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value hash"><a href="https://live.xdbchain.com/account/${tx.source_account}" target="_blank">${tx.source_account}</a></div>
                    </div>
                    <div class="detail-item">
    ...
    displayPayments(data) {
        ...
        container.innerHTML = payments.map(payment => {
            const isSent = payment.from === this.currentWallet;
            const typeLabel = isSent ? 'Sent' : 'Received';
            const typeClass = isSent ? 'text-error' : 'text-success';
            return `
            <div class="payment-item">
                <div class="item-header">
                    <span class="item-type ${typeClass}">${typeLabel} ${payment.type}</span>
                    <span class="item-date">${new Date(payment.created_at).toLocaleString()}</span>
                </div>
                <div class="item-details">
                    <div class="detail-item">
                        <div class="detail-label">From</div>
                        <div class="detail-value hash"><a href="https://live.xdbchain.com/account/${payment.from}" target="_blank">${payment.from || 'N/A'}</a></div>
                    </div>
                    <div class="detail-item">
                        <div class="detail-label">To</div>
                        <div class="detail-value hash"><a href="https://live.xdbchain.com/account/${payment.to}" target="_blank">${payment.to || 'N/A'}</a></div>
                    </div>
                    <div class="detail-item">
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value hash"><a href="https://live.xdbchain.com/tx/${payment.transaction_hash}" target="_blank">${payment.transaction_hash}</a></div>
                    </div>
                </div>
            </div>
        `;
